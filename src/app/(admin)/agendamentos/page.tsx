    ...
    <div className="p-6 md:p-10 max-w-6xl mx-auto min-h-screen pb-24">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap bg-white border-4 border-black shadow-[4px_4px_0px_0px_#000] overflow-hidden">
          <button onClick={() => setFilter("all")} className={cn("px-4 py-2 font-black uppercase text-sm border-r-4 border-black transition-colors", filter === "all" ? "bg-purple-500 text-white" : "hover:bg-purple-100")}>Todos</button>
                ...
                <div className="flex justify-between items-start mb-6 border-b-4 border-black pb-4">
                  <div className="flex flex-col">
                    <span className="font-black text-2xl uppercase flex items-center gap-2">
                      <Calendar className="w-6 h-6 text-purple-600" strokeWidth={3} /> {appt.date}
                    </span>
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <p className="font-bold text-gray-600 flex items-center gap-2 mt-1">
                      ...
                      <a href={`https://wa.me/55${appt.patientPhone?.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="hover:text-purple-600 hover:underline">{appt.patientPhone}</a>
                    </p>
                  </div>

                  <div className="bg-purple-100 border-l-4 border-purple-500 p-3">
                    <p className="font-bold text-xs uppercase text-purple-800 tracking-widest mb-1">Tratamento</p>
                    <p className="font-black text-lg uppercase text-purple-900">{appt.serviceName}</p>
                  </div>
