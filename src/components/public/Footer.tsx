...
const WHATSAPP_NUMBER = "5511984099457";
const INSTAGRAM_LINK = "https://www.instagram.com/laislaurentino.podologia?igsh=NDhtdHYzZnhmNmxp";
const MAPS_LINK = "https://maps.app.goo.gl/PZ9Pid28Mt8k1py87";
...
export function Footer() {
  ...
  return (
    <footer className="w-full relative z-10 flex flex-col">
        ...
        <div className="container mx-auto max-w-5xl flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          ...
          <div className="w-full md:w-auto">
            ...
            <a 
              ...
              className="group relative inline-flex items-center justify-center font-black text-xl md:text-2xl uppercase tracking-wider bg-pink-500 text-white border-4 border-black px-8 py-5 shadow-brutal hover:bg-pink-400 hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_#0f0f0f] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none transition-all duration-200 w-full md:w-auto"
            >
              Falar no WhatsApp
      ...
      <div className="bg-brutal-black text-white pt-20 pb-12 px-6 border-b-8 border-pink-500">
  ...
  <div className="bg-white border-4 border-black px-6 py-3 shadow-[6px_6px_0px_0px_#ec4899] mb-8 -rotate-2">
  ...
  <div className="flex gap-4">
    <a href={INSTAGRAM_LINK} target="_blank" rel="noopener noreferrer" className="bg-white text-black border-4 border-black p-3 hover:bg-yellow-400 hover:-translate-y-1 transition-all shadow-[4px_4px_0px_0px_#ec4899]">
      <Instagram className="w-6 h-6" strokeWidth={2.5} />
    </a>
    <a href="#" target="_blank" rel="noopener noreferrer" className="bg-white text-black border-4 border-black p-3 hover:bg-yellow-400 hover:-translate-y-1 transition-all shadow-[4px_4px_0px_0px_#ec4899]">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="flex flex-col gap-6 font-bold text-gray-300">
              <li className="flex flex-col md:flex-row items-center md:items-start gap-3 group">
                <MapPin className="w-6 h-6 text-pink-400 flex-shrink-0 group-hover:text-yellow-400 transition-colors" />
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="flex flex-col gap-4 font-bold text-gray-300 w-full max-w-xs">
              ...
              <li className="flex justify-between items-center text-gray-500">
                ...
                <span>Fechado</span>
              </li><li className="flex justify-between items-center text-gray-500">
                <div className="flex items-center gap-2">
                  <Clock className="w-5 h-5 text-gray-500" />
                  <span>Domingo</span>
                </div>
        ...
        <div className="container mx-auto max-w-7xl mt-16 pt-8 border-t-4 border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-bold text-gray-500">
          ...
          <div className="flex items-center gap-2">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-pink-900 text-white px-2 py-1 border-2 border-pink-500 hover:bg-yellow-400 hover:text-black hover:border-black transition-colors uppercase tracking-widest font-black"
            >
              Zanvexis
            </a>
          </div>
